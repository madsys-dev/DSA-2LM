...
function func_memtis_setting() {
    ...
    echo 10000 | tee /sys/kernel/mm/htmm/htmm_adaptation_period
...
function func_main() {
    ...
    # PINNING="taskset -c 0-35"
	# PINNING="taskset -c 48-95,144-191" # Node 1
    # PINNING="taskset -c 0-47,96-143" # Node 0
