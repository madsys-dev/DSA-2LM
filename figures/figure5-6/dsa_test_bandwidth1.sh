...
function main() {
    ...
    dsa_channel_test
    # dsa_batch_size_test # Remember to enable hyper-threading as work_queue_siz is 128, 
                        # so require num_online_cpus >= 128. We only synchronize for DSA
