...
static int __idxd_driver_register(struct idxd_device_driver *idxd_drv, struct module *owner,
			   const char *mod_name)
{
...
static void idxd_driver_unregister(struct idxd_device_driver *idxd_drv)
{
